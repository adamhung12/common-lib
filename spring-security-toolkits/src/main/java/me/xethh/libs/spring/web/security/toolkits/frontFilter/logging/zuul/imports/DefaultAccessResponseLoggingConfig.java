...
import me.xethh.libs.spring.web.security.toolkits.frontFilter.logging.zuul.DefaultResponseAccessLogging;
...
public class DefaultAccessResponseLoggingConfig {
    @Bean
    public DefaultResponseAccessLogging defaultZuulAccessResponseLogging(
